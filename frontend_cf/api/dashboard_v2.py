...
DEFAULT_CONFIG = {
    ...
    "MY_PHONE_DISPLAY": "+91 7011613319",
    "MY_PIN_CODE": "110001",
    "MY_COMPANY": "HyperStaff",
    "MY_WEBSITE": "https://hyperstaff.co",
    "MY_ADDRESS": "NEW DELHI, INDIA",
    "MY_TITLE": "Virtual Assistant Support for {company_name} - {MY_COMPANY}",
    "PITCH_MESSAGE": "",
    "OPENAI_API_KEY": "",
    "NOPECHA_API_KEY": "",
    "SPREADSHEET_ID": "",
...
def _run_subprocess(run_id, csv_path, cfg):
    ...
    for key in ["OPENAI_API_KEY", "NOPECHA_API_KEY", "SPREADSHEET_ID", "CREDS_FILE",
                ...
                "MY_PHONE_INTL", "MY_PHONE_DISPLAY", "MY_PIN_CODE", "MY_COMPANY", "MY_WEBSITE",
                "MY_ADDRESS", "MY_TITLE", "PITCH_MESSAGE"]:
        if cfg.get(key):
            env[key] = str(cfg[key])
...
def update_settings():
    ...
    for key in ["MY_FIRST_NAME", "MY_LAST_NAME", "MY_FULL_NAME", "MY_EMAIL", "MY_PHONE",
                "MY_PHONE_INTL", "MY_PHONE_DISPLAY", "MY_PIN_CODE", "MY_COMPANY", "MY_WEBSITE",
                "MY_ADDRESS", "MY_TITLE", "PITCH_MESSAGE", "SPREADSHEET_ID", "CREDS_FILE",
